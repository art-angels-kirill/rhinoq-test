        ...
        array(
            ...
            'attr' => array(
                'general' => array(
                    ...
                    'variation' => array(
                        'type' => 'select',
                        'title' => JText::_('COM_SPPAGEBUILDER_ADDON_SF_VARIATION'),
                        'desc' => JText::_('COM_SPPAGEBUILDER_ADDON_SF_VARIATION_DESC'),
                        'values' => array(
                            'simple' => JText::_('COM_SPPAGEBUILDER_ADDON_SF_VARIATION_SIMPLE'),
                            'advanced' => JText::_('COM_SPPAGEBUILDER_ADDON_SF_VARIATION_ADVANCED'),
                            'animation' => JText::_('COM_SPPAGEBUILDER_ADDON_SF_VARIATION_ANIMTION'),
                        ),
                        'std' => 1,
                    ),
                    'arrows' => array(
                    ...
                    'main_bg' => array(
                        'type' => 'media',
                        'title' => JText::_('COM_SPPAGEBUILDER_ADDON_SF_BACKGROUND_IMAGE'),
                        'desc' => JText::_('COM_SPPAGEBUILDER_ADDON_SF_BACKGROUND_IMAGE_DESC'),
                        // 'depends' => array('variation' => 'animation'),
                    ),
                    'class' => array(
                        'type' => 'text',
