...
class SppagebuilderAddonModal extends SppagebuilderAddons {
    ...
    public function render() {
        ...
        if ($modal_selector == 'image') {
            if ($selector_image) {
                $output .= '<a class="sppb-modal-selector sppb-magnific-popup" ' . $attribs . ' href="' . $url . '" id="' . $modal_unique_id . '-selector"><img src="' . $selector_image . '" alt=""><span class="bubble-ripple"><span class="bubble-ripple-inner"></span></span><i class="fa fa-play" aria-hidden="true"></i>';
	    ...
	    <# if(data.modal_selector == "image") { #>
	      <a class="sppb-modal-selector sppb-magnific-popup" {{{ attribs }}} href=\'{{ modalUrl }}\' id="{{ modalUniqueId }}-selector">
					<img src=\'{{ data.selector_image }}\' alt="">
                                        <span class="bubble-ripple"><span class="bubble-ripple-inner"></span></span><i class="fa fa-play" aria-hidden="true"></i>
