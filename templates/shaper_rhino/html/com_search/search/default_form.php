	...
	<form id="searchForm" action="<?php echo JRoute::_('index.php?option=com_search');?>" method="post">
		...
		<div class="btn-toolbar">
			<div class="input-search-wrap">
				<div class="btn-group pull-left input-wrap">
				...
				<div class="btn-group pull-left">
					<button name="Search" onclick="this.form.submit()" class="btn hasTooltip" title="<?php echo JHtml::tooltipText('COM_SEARCH_SEARCH');?>"><?php echo JText::_('JSEARCH_FILTER_SUBMIT'); ?><span class="icon-search"></span></button>
				</div>
				<input type="hidden" name="task" value="search" />
			</div> <!-- /.input-search-wrap -->
			<div class="clearfix"></div>

			<?php if ($this->total > 0) : ?>
			<div class="form-limit-wrap">
